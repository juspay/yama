...
Return ONLY valid JSON:
{
  ...
  /**
   * Get safe token limit for batch processing
   */
  private getSafeTokenLimit(): number {
    // Conservative token limit to avoid hitting API limits
    // Most models have limits around 128k-200k tokens
    return 100000; // 100k tokens as a safe default
  }
